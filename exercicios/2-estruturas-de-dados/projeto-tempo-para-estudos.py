...
print('O estudante',nome,'do curso de',curso, 'dedica',total_dias,' dias por mes,',total_horas,'por semana aos estudos, perfazendo um total de',total_dias*total_horas)